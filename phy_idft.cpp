...
const static __m128i IDFT_IQ_switch =  _mm_setr_epi8(2,3,0,1,6,7,4,5,10,11,8,9,14,15,12,13);
const static __m128i IDFT_Neg_R = _mm_setr_epi8(0xFF, 0xFF, 0x1, 0x1, 0xFF, 0xFF, 0x1, 0x1, 0xFF, 0xFF, 0x1, 0x1, 0xFF, 0xFF, 0x1, 0x1);
const static __m128i IDFT_Const_0707 = _mm_setr_epi8(0x7F, 0x5A, 0x7F, 0x5A, 0x7F, 0x5A, 0x7F, 0x5A,0x7F, 0x5A, 0x7F, 0x5A, 0x7F, 0x5A, 0x7F, 0x5A);
const static __m128i IDFT_Const_0707_Minus = _mm_setr_epi8(0x81, 0xA5,0x81, 0xA5,0x81, 0xA5,0x81, 0xA5,0x81, 0xA5,0x81, 0xA5,0x81, 0xA5,0x81, 0xA5); 
const static __m128i IDFT_ConstMinus08660 = _mm_setr_epi8(0xD9, 0x6E, 0xD9, 0x6E, 0xD9, 0x6E, 0xD9, 0x6E, 0xD9, 0x6E, 0xD9, 0x6E, 0xD9, 0x6E, 0xD9, 0x6E);
const static __m128i IDFT_Const0500_0866_0 = _mm_setr_epi8(0x00, 0x40, 0x00, 0x40, 0x00, 0x40, 0x00, 0x40, 0x00, 0x40, 0x00, 0x40, 0x00, 0x40, 0x00, 0x40); /* c c 0.5*/
const static __m128i IDFT_Const0500_0866_1 = _mm_setr_epi8(0x27, 0x91, 0xD9, 0x6E, 0x27, 0x91, 0xD9, 0x6E, 0x27, 0x91, 0xD9, 0x6E, 0x27, 0x91, 0xD9, 0x6E); /* -d  d  -0.86 0.86*/ /*diff*/
const static __m128i IDFT_Const0500_0866_2 = _mm_setr_epi8(0x00, 0xC0,0x00, 0xC0, 0x00, 0xC0,0x00, 0xC0, 0x00, 0xC0,0x00, 0xC0 ,0x00, 0xC0,0x00, 0xC0) /*c -0.5*/;
const static __m128i IDFT_Const03090 = _mm_setr_epi8(0x8D, 0x27, 0x8D, 0x27, 0x8D, 0x27, 0x8D, 0x27, 0x8D, 0x27, 0x8D, 0x27, 0x8D, 0x27, 0x8D, 0x27);
const static __m128i IDFT_Const08090 = _mm_setr_epi8(0x8D, 0x67, 0x8D, 0x67, 0x8D, 0x67, 0x8D, 0x67, 0x8D, 0x67, 0x8D, 0x67, 0x8D, 0x67, 0x8D, 0x67);
const static __m128i IDFT_Const09511 = _mm_setr_epi8(0xBE, 0x79, 0xBE, 0x79, 0xBE, 0x79, 0xBE, 0x79, 0xBE, 0x79, 0xBE, 0x79, 0xBE, 0x79, 0xBE, 0x79);
const static __m128i IDFT_Const05878 = _mm_setr_epi8(0x3D, 0x4B, 0x3D, 0x4B, 0x3D, 0x4B, 0x3D, 0x4B, 0x3D, 0x4B, 0x3D, 0x4B, 0x3D, 0x4B, 0x3D, 0x4B);
const static __m128i IDFT_Const_07660 = _mm_setr_epi8(0x0C, 0x62, 0x0C, 0x62, 0x0C, 0x62, 0x0C, 0x62, 0x0C, 0x62, 0x0C, 0x62, 0x0C, 0x62, 0x0C, 0x62);/*c, c*/
const static __m128i IDFT_Const_06428 = _mm_setr_epi8(0x47, 0x52, 0xB9, 0xAD, 0x47, 0x52, 0xB9, 0xAD, 0x47, 0x52, 0xB9, 0xAD, 0x47, 0x52, 0xB9, 0xAD);/*d, -d*/
const static __m128i IDFT_Const_01736 = _mm_setr_epi8(0x39, 0x16, 0x39, 0x16, 0x39, 0x16, 0x39, 0x16, 0x39, 0x16, 0x39, 0x16, 0x39, 0x16, 0x39, 0x16);/*c, c*/
const static __m128i IDFT_Const_09848 = _mm_setr_epi8(0x0E, 0x7E, 0xF2, 0x81, 0x0E, 0x7E, 0xF2, 0x81, 0x0E, 0x7E, 0xF2, 0x81, 0x0E, 0x7E, 0xF2, 0x81);/*d, -d*/
const static __m128i IDFT_Const_Minus09397 = _mm_setr_epi8(0xB8, 0x87, 0xB8, 0x87, 0xB8, 0x87, 0xB8, 0x87, 0xB8, 0x87, 0xB8, 0x87, 0xB8, 0x87, 0xB8, 0x87);/*c, c*/
const static __m128i IDFT_Const_03420 = _mm_setr_epi8(0xC7, 0x2B, 0x39, 0xD4, 0xC7, 0x2B, 0x39, 0xD4, 0xC7, 0x2B, 0x39, 0xD4, 0xC7, 0x2B, 0x39, 0xD4);/*d, -d*/
...
void init_idft12_twiddle_factor(WORD16 *r12twiddle)
{
	...
	//printf("12-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft15_twiddle_factor(WORD16 *r15twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("15-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft16_twiddle_factor(WORD16 *r16twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("16-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft18_twiddle_factor(WORD16 *r18twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("18-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft20_twiddle_factor(WORD16 *r20twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("20-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft24_twiddle_factor(WORD16 *r24twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	// printf("24-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft25_twiddle_factor(WORD16 *r25twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("25-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft27_twiddle_factor(WORD16 *r27twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("27-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft30_twiddle_factor(WORD16 *r30twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("30-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft32_twiddle_factor(WORD16 *r32twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor = 32768;
	//printf("32-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft36_twiddle_factor(WORD16 *r36twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("36-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft40_twiddle_factor(WORD16 *r40twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("40-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft48_twiddle_factor(WORD16 *r48twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("48-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft648_twiddle_factor(WORD16 *r648twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("648-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft720_twiddle_factor(WORD16 *r720twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("720-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft768_twiddle_factor(WORD16 *r768twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("768-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft864_twiddle_factor(WORD16 *r864twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("864-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft900_twiddle_factor(WORD16 *r900twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("900-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft960_twiddle_factor(WORD16 *r960twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("960-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft972_twiddle_factor(WORD16 *r972twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("972-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft1080_twiddle_factor(WORD16 *r1080twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("1080-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft1152_twiddle_factor(WORD16 *r1152twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("1152-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft1200_twiddle_factor(WORD16 *r1200twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor=  32768;
	//printf("1200-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
void init_idft1536_twiddle_factor(WORD16 *r1536twiddle)
{
    WORD32 i, j;
    DOUBLE64 factor = 32768;
	//printf("1536-point IDFT initilization. Developed by Intel Lab China. 2012/04/17.\n");
...
{\
	...
	m128_t1 = _mm_mulhrs_epi16(m128_t1, IDFT_ConstMinus08660); \
	m128_t1 = _mm_shuffle_epi8(m128_t1, IDFT_IQ_switch);\
	m128_t1 = _mm_sign_epi16(m128_t1, IDFT_Neg_R); \
	\
...
{ \
	...
	m128_t4 = _mm_mulhrs_epi16(m128_t4, IDFT_ConstMinus08660); \
	m128_t4 = _mm_shuffle_epi8(m128_t4, IDFT_IQ_switch); \
	m128_t4 = _mm_sign_epi16(m128_t4, IDFT_Neg_R); \
	 \
...
{\
	...
	m128_t12 = _mm_shuffle_epi8(m128_t12, IDFT_IQ_switch);\
	m128_t12 = _mm_sign_epi16(m128_t12, IDFT_Neg_R); \
	 \
	m128_t7 = _mm_adds_epi16(m128_t3,m128_t12); \
	m128_t3 = _mm_subs_epi16(m128_t3,m128_t12); \
	 \
...
{ \
	...
	m128_t7 = _mm_shuffle_epi8(m128_t7, IDFT_IQ_switch); \
	m128_t7 = _mm_sign_epi16(m128_t7, IDFT_Neg_R); \
	 \
...
{ \
	...
	m128_t8 = _mm_subs_epi16(m128_t2, m128_t3); \
	 \
	m128_t9 = _mm_mulhrs_epi16(m128_t5, IDFT_Const03090); \
	m128_t10 = _mm_mulhrs_epi16(m128_t5, IDFT_Const08090); \
	m128_t11 = _mm_mulhrs_epi16(m128_t6, IDFT_Const03090); \
	m128_t12 = _mm_mulhrs_epi16(m128_t6, IDFT_Const08090); \
	 \
	m128_t1 = _mm_mulhrs_epi16(m128_t7, IDFT_Const09511); \
	m128_t1 = _mm_shuffle_epi8(m128_t1, IDFT_IQ_switch); \
	m128_t1 = _mm_sign_epi16(m128_t1, IDFT_Neg_R); \
	m128_t2 = _mm_mulhrs_epi16(m128_t7, IDFT_Const05878); \
	m128_t2 = _mm_shuffle_epi8(m128_t2, IDFT_IQ_switch); \
	m128_t2 = _mm_sign_epi16(m128_t2, IDFT_Neg_R); \
	m128_t3 = _mm_mulhrs_epi16(m128_t8, IDFT_Const09511); \
	m128_t3 = _mm_shuffle_epi8(m128_t3, IDFT_IQ_switch); \
	m128_t3 = _mm_sign_epi16(m128_t3, IDFT_Neg_R); \
	m128_t4 = _mm_mulhrs_epi16(m128_t8, IDFT_Const05878); \
	m128_t4 = _mm_shuffle_epi8(m128_t4, IDFT_IQ_switch); \
	m128_t4 = _mm_sign_epi16(m128_t4, IDFT_Neg_R); \
	 \
...
{ \
	...
	m128_t2 = _mm_shuffle_epi8(m128_t9, IDFT_IQ_switch); \
	m128_t0 = _mm_mulhrs_epi16(m128_t9, IDFT_Const0500_0866_0); \
	m128_t1 = _mm_mulhrs_epi16(m128_t2, IDFT_Const0500_0866_1); \
	m128_t9 = _mm_adds_epi16(m128_t0, m128_t1); \
	 \
	m128_t2 = _mm_shuffle_epi8(m128_t11, IDFT_IQ_switch); \
	m128_t0 = _mm_mulhrs_epi16(m128_t11, IDFT_Const0500_0866_2); \
	m128_t1 = _mm_mulhrs_epi16(m128_t2, IDFT_Const0500_0866_1); \
...
{ \
	...
	m128_t1 = _mm_sign_epi16(m128_t1, IDFT_Neg_R); \
	 \
	m128_t2 = _mm_mulhrs_epi16(m128_t11, IDFT_Const_0707); \
	m128_t3 = _mm_mulhrs_epi16(m128_t5, IDFT_Const_0707_Minus); \
	 \
	m128_t6 = _mm_shuffle_epi8(m128_t2, IDFT_IQ_switch); \
	m128_t7 = _mm_adds_epi16(m128_t2, m128_t6); \
	m128_t2 = _mm_subs_epi16(m128_t2, m128_t6); \
	m128_t11 = _mm_blend_epi16(m128_t2, m128_t7, 0xAA); \
	 \
	m128_t6 = _mm_shuffle_epi8(m128_t3, IDFT_IQ_switch); \
...
{ \
	...
	m128_t11 = _mm_blend_epi16(m128_t2, m128_t7, 0xAA); \
	 \
	m128_t6 = _mm_shuffle_epi8(m128_t3, IDFT_IQ_switch); 	m128_t7 = _mm_adds_epi16(m128_t3, m128_t6); \
	m128_t3 = _mm_subs_epi16(m128_t3, m128_t6); \
	m128_t5 = _mm_blend_epi16(m128_t3, m128_t7, 0x55); \
	 \
	out_addr_temp1 = out_addr; \
...
{ \
	...
	radix3_register(m128_t4, m128_t7, m128_t10, m128_t3, m128_t6, m128_t9); \
	 \
	m128_t4 = _mm_mulhrs_epi16(m128_t5, IDFT_Const_07660); \
	m128_t7 = _mm_mulhrs_epi16(m128_t5, IDFT_Const_06428); \
	m128_t7 = _mm_shuffle_epi8(m128_t7, IDFT_IQ_switch); \
	m128_t5 = _mm_adds_epi16(m128_t4, m128_t7); \
	 \
	m128_t4 = _mm_mulhrs_epi16(m128_t8, IDFT_Const_01736); \
	m128_t7 = _mm_mulhrs_epi16(m128_t8, IDFT_Const_09848); \
	m128_t7 = _mm_shuffle_epi8(m128_t7, IDFT_IQ_switch); \
	m128_t8 = _mm_adds_epi16(m128_t4, m128_t7); \
	 \
	m128_t4 = _mm_mulhrs_epi16(m128_t6, IDFT_Const_01736); \
	m128_t7 = _mm_mulhrs_epi16(m128_t6, IDFT_Const_09848); \
	m128_t7 = _mm_shuffle_epi8(m128_t7, IDFT_IQ_switch); \
	m128_t6 = _mm_adds_epi16(m128_t4, m128_t7); \
	 \
	m128_t4 = _mm_mulhrs_epi16(m128_t9, IDFT_Const_Minus09397); \
	m128_t7 = _mm_mulhrs_epi16(m128_t9, IDFT_Const_03420); \
	m128_t7 = _mm_shuffle_epi8(m128_t7, IDFT_IQ_switch); \
...
{ \
	radix4_0_zeromul(InBuf + 0*in_span, 3*in_span, idft_Temp_Buf + 0*4, 1); \
	radix4_0_mul_span(InBuf + 1*in_span, 3*in_span, idft_Temp_Buf + 1*4, 1, r12twiddle + 2*4*1, 1); \
	radix4_0_mul_span(InBuf + 2*in_span, 3*in_span, idft_Temp_Buf + 2*4, 1, r12twiddle + 2*4*2, 1); \
	 \
	radix3_0(idft_Temp_Buf + 0, 4, OutBuf + 0*out_span, 4*out_span); \
	radix3_0(idft_Temp_Buf + 1, 4, OutBuf + 1*out_span, 4*out_span); \
	radix3_0(idft_Temp_Buf + 2, 4, OutBuf + 2*out_span, 4*out_span); \
	radix3_0(idft_Temp_Buf + 3, 4, OutBuf + 3*out_span, 4*out_span); \
}
...
{ \
	...
	radix4_0_mul_span(InBuf + 2*in_span, 3*in_span, idft_Temp_Buf + 2*4, 1, r12twiddle + 2*4*2, 1); \
	 \
	radix3_0_zeromul(idft_Temp_Buf + 0, 4, OutBuf + 0*out_span, 4*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 1, 4, OutBuf + 1*out_span, 4*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 2, 4, OutBuf + 2*out_span, 4*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 3, 4, OutBuf + 3*out_span, 4*out_span); \
}
...
{ \
	...
	radix4_0_mul_span(InBuf + 2*in_span, 3*in_span, idft_Temp_Buf + 2*4, 1, r12twiddle + 2*4*2, 1); \
	 \
	radix3_0_mul_span(idft_Temp_Buf + 0, 4, OutBuf + 0*out_span, 4*out_span, twiddle + 2*out_span*twiddle_scale*0, 4*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 1, 4, OutBuf + 1*out_span, 4*out_span, twiddle + 2*out_span*twiddle_scale*1, 4*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 2, 4, OutBuf + 2*out_span, 4*out_span, twiddle + 2*out_span*twiddle_scale*2, 4*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 3, 4, OutBuf + 3*out_span, 4*out_span, twiddle + 2*out_span*twiddle_scale*3, 4*out_span*twiddle_scale); \
}

#define radix15(InBuf, in_span, OutBuf, out_span, r15twiddle) \
{ \
	radix5_0_zeromul(InBuf + 0*in_span, 3*in_span, idft_Temp_Buf + 0*5, 1); \
	radix5_0_mul_span(InBuf + 1*in_span, 3*in_span, idft_Temp_Buf + 1*5, 1, r15twiddle + 2*5*1, 1); \
	radix5_0_mul_span(InBuf + 2*in_span, 3*in_span, idft_Temp_Buf + 2*5, 1, r15twiddle + 2*5*2, 1); \
	 \
	radix3_0(idft_Temp_Buf + 0, 5, OutBuf + 0*out_span, 5*out_span); \
	radix3_0(idft_Temp_Buf + 1, 5, OutBuf + 1*out_span, 5*out_span); \
	radix3_0(idft_Temp_Buf + 2, 5, OutBuf + 2*out_span, 5*out_span); \
	radix3_0(idft_Temp_Buf + 3, 5, OutBuf + 3*out_span, 5*out_span); \
	radix3_0(idft_Temp_Buf + 4, 5, OutBuf + 4*out_span, 5*out_span); \
}

#define radix16(InBuf, in_span, OutBuf, out_span, r16twiddle) \
{ \
	radix4_0_zeromul(InBuf + 0*in_span, 4*in_span, idft_Temp_Buf + 0*4, 1); \
	radix4_0_mul_span(InBuf + 1*in_span, 4*in_span, idft_Temp_Buf + 1*4, 1, r16twiddle + 2*4*1, 1); \
	radix4_0_mul_span(InBuf + 2*in_span, 4*in_span, idft_Temp_Buf + 2*4, 1, r16twiddle + 2*4*2, 1); \
	radix4_0_mul_span(InBuf + 3*in_span, 4*in_span, idft_Temp_Buf + 3*4, 1, r16twiddle + 2*4*3, 1); \
	 \
	radix4_0(idft_Temp_Buf + 0, 4, OutBuf + 0*out_span, 4*out_span); \
	radix4_0(idft_Temp_Buf + 1, 4, OutBuf + 1*out_span, 4*out_span); \
	radix4_0(idft_Temp_Buf + 2, 4, OutBuf + 2*out_span, 4*out_span); \
	radix4_0(idft_Temp_Buf + 3, 4, OutBuf + 3*out_span, 4*out_span); \
}
...
{ \
	...
	radix4_0_mul_span(InBuf + 3*in_span, 4*in_span, idft_Temp_Buf + 3*4, 1, r16twiddle + 2*4*3, 1); \
	 \
	radix4_0_zeromul(idft_Temp_Buf + 0, 4, OutBuf + 0*out_span, 4*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 1, 4, OutBuf + 1*out_span, 4*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 2, 4, OutBuf + 2*out_span, 4*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 3, 4, OutBuf + 3*out_span, 4*out_span); \
}
...
{ \
	...
	radix4_0_mul_span(InBuf + 3*in_span, 4*in_span, idft_Temp_Buf + 3*4, 1, r16twiddle + 2*4*3, 1); \
	 \
	radix4_0_mul_span(idft_Temp_Buf + 0, 4, OutBuf + 0*out_span, 4*out_span, twiddle + 2*out_span*twiddle_scale*0, 4*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 1, 4, OutBuf + 1*out_span, 4*out_span, twiddle + 2*out_span*twiddle_scale*1, 4*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 2, 4, OutBuf + 2*out_span, 4*out_span, twiddle + 2*out_span*twiddle_scale*2, 4*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 3, 4, OutBuf + 3*out_span, 4*out_span, twiddle + 2*out_span*twiddle_scale*3, 4*out_span*twiddle_scale); \
}

#define radix18_0_zeromul(InBuf, in_span, OutBuf, out_span, r18twiddle) \
{ \
	radix6_0_zeromul(InBuf + 0*in_span, 3*in_span, idft_Temp_Buf + 0*6, 1); \
	radix6_0_mul_span(InBuf + 1*in_span, 3*in_span, idft_Temp_Buf + 1*6, 1, r18twiddle + 2*6*1, 1); \
	radix6_0_mul_span(InBuf + 2*in_span, 3*in_span, idft_Temp_Buf + 2*6, 1, r18twiddle + 2*6*2, 1); \
	 \
	radix3_0_zeromul(idft_Temp_Buf + 0, 6, OutBuf + 0*out_span, 6*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 1, 6, OutBuf + 1*out_span, 6*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 2, 6, OutBuf + 2*out_span, 6*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 3, 6, OutBuf + 3*out_span, 6*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 4, 6, OutBuf + 4*out_span, 6*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 5, 6, OutBuf + 5*out_span, 6*out_span); \
}
...
{ \
	...
	radix6_0_mul_span(InBuf + 2*in_span, 3*in_span, idft_Temp_Buf + 2*6, 1, r18twiddle + 2*6*2, 1); \
	 \
	radix3_0_mul_span(idft_Temp_Buf + 0, 6, OutBuf + 0*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*0, 6*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 1, 6, OutBuf + 1*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*1, 6*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 2, 6, OutBuf + 2*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*2, 6*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 3, 6, OutBuf + 3*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*3, 6*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 4, 6, OutBuf + 4*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*4, 6*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 5, 6, OutBuf + 5*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*5, 6*out_span*twiddle_scale); \
}

#define radix20(InBuf, in_span, OutBuf, out_span, r20twiddle) \
{ \
	radix5_0_zeromul(InBuf + 0*in_span, 4*in_span, idft_Temp_Buf + 0*5, 1); \
	radix5_0_mul_span(InBuf + 1*in_span, 4*in_span, idft_Temp_Buf + 1*5, 1, r20twiddle + 2*5*1, 1); \
	radix5_0_mul_span(InBuf + 2*in_span, 4*in_span, idft_Temp_Buf + 2*5, 1, r20twiddle + 2*5*2, 1); \
	radix5_0_mul_span(InBuf + 3*in_span, 4*in_span, idft_Temp_Buf + 3*5, 1, r20twiddle + 2*5*3, 1); \
	 \
	radix4_0(idft_Temp_Buf + 0, 5, OutBuf + 0*out_span, 5*out_span); \
	radix4_0(idft_Temp_Buf + 1, 5, OutBuf + 1*out_span, 5*out_span); \
	radix4_0(idft_Temp_Buf + 2, 5, OutBuf + 2*out_span, 5*out_span); \
	radix4_0(idft_Temp_Buf + 3, 5, OutBuf + 3*out_span, 5*out_span); \
	radix4_0(idft_Temp_Buf + 4, 5, OutBuf + 4*out_span, 5*out_span); \
}
...
{ \
	...
	radix5_0_mul_span(InBuf + 3*in_span, 4*in_span, idft_Temp_Buf + 3*5, 1, r20twiddle + 2*5*3, 1); \
	 \
	radix4_0_zeromul(idft_Temp_Buf + 0, 5, OutBuf + 0*out_span, 5*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 1, 5, OutBuf + 1*out_span, 5*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 2, 5, OutBuf + 2*out_span, 5*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 3, 5, OutBuf + 3*out_span, 5*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 4, 5, OutBuf + 4*out_span, 5*out_span); \
}
...
{ \
	...
	radix5_0_mul_span(InBuf + 3*in_span, 4*in_span, idft_Temp_Buf + 3*5, 1, r20twiddle + 2*5*3, 1); \
	 \
	radix4_0_mul_span(idft_Temp_Buf + 0, 5, OutBuf + 0*out_span, 5*out_span, twiddle + 2*out_span*twiddle_scale*0, 5*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 1, 5, OutBuf + 1*out_span, 5*out_span, twiddle + 2*out_span*twiddle_scale*1, 5*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 2, 5, OutBuf + 2*out_span, 5*out_span, twiddle + 2*out_span*twiddle_scale*2, 5*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 3, 5, OutBuf + 3*out_span, 5*out_span, twiddle + 2*out_span*twiddle_scale*3, 5*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 4, 5, OutBuf + 4*out_span, 5*out_span, twiddle + 2*out_span*twiddle_scale*4, 5*out_span*twiddle_scale); \
}

#define radix24(InBuf, in_span, OutBuf, out_span, r24twiddle) \
{ \
	radix6_0_zeromul(InBuf + 0*in_span, 4*in_span, idft_Temp_Buf + 0*6, 1); \
	radix6_0_mul_span(InBuf + 1*in_span, 4*in_span, idft_Temp_Buf + 1*6, 1, r24twiddle + 2*6*1, 1); \
	radix6_0_mul_span(InBuf + 2*in_span, 4*in_span, idft_Temp_Buf + 2*6, 1, r24twiddle + 2*6*2, 1); \
	radix6_0_mul_span(InBuf + 3*in_span, 4*in_span, idft_Temp_Buf + 3*6, 1, r24twiddle + 2*6*3, 1); \
	 \
	radix4_0(idft_Temp_Buf + 0, 6, OutBuf + 0*out_span, 6*out_span); \
	radix4_0(idft_Temp_Buf + 1, 6, OutBuf + 1*out_span, 6*out_span); \
	radix4_0(idft_Temp_Buf + 2, 6, OutBuf + 2*out_span, 6*out_span); \
	radix4_0(idft_Temp_Buf + 3, 6, OutBuf + 3*out_span, 6*out_span); \
	radix4_0(idft_Temp_Buf + 4, 6, OutBuf + 4*out_span, 6*out_span); \
	radix4_0(idft_Temp_Buf + 5, 6, OutBuf + 5*out_span, 6*out_span); \
}
...
{ \
	...
	radix6_0_mul_span(InBuf + 3*in_span, 4*in_span, idft_Temp_Buf + 3*6, 1, r24twiddle + 2*6*3, 1); \
	 \
	radix4_0_zeromul(idft_Temp_Buf + 0, 6, OutBuf + 0*out_span, 6*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 1, 6, OutBuf + 1*out_span, 6*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 2, 6, OutBuf + 2*out_span, 6*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 3, 6, OutBuf + 3*out_span, 6*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 4, 6, OutBuf + 4*out_span, 6*out_span); \
	radix4_0_zeromul(idft_Temp_Buf + 5, 6, OutBuf + 5*out_span, 6*out_span); \
}
...
{ \
	...
	radix6_0_mul_span(InBuf + 3*in_span, 4*in_span, idft_Temp_Buf + 3*6, 1, r24twiddle + 2*6*3, 1); \
	 \
	radix4_0_mul_span(idft_Temp_Buf + 0, 6, OutBuf + 0*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*0, 6*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 1, 6, OutBuf + 1*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*1, 6*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 2, 6, OutBuf + 2*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*2, 6*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 3, 6, OutBuf + 3*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*3, 6*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 4, 6, OutBuf + 4*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*4, 6*out_span*twiddle_scale); \
	radix4_mul_span(idft_Temp_Buf + 5, 6, OutBuf + 5*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*5, 6*out_span*twiddle_scale); \
}

#define radix25(InBuf, in_span, OutBuf, out_span, r25twiddle) \
{ \
	radix5_0_zeromul(InBuf + 0*in_span, 5*in_span, idft_Temp_Buf + 0*5, 1); \
	radix5_0_mul_span(InBuf + 1*in_span, 5*in_span, idft_Temp_Buf + 1*5, 1, r25twiddle + 2*5*1, 1); \
	radix5_0_mul_span(InBuf + 2*in_span, 5*in_span, idft_Temp_Buf + 2*5, 1, r25twiddle + 2*5*2, 1); \
	radix5_0_mul_span(InBuf + 3*in_span, 5*in_span, idft_Temp_Buf + 3*5, 1, r25twiddle + 2*5*3, 1); \
	radix5_0_mul_span(InBuf + 4*in_span, 5*in_span, idft_Temp_Buf + 4*5, 1, r25twiddle + 2*5*4, 1);  \
	 \
	radix5_0(idft_Temp_Buf + 0, 5, OutBuf + 0*out_span, 5*out_span); \
	radix5_0(idft_Temp_Buf + 1, 5, OutBuf + 1*out_span, 5*out_span); \
	radix5_0(idft_Temp_Buf + 2, 5, OutBuf + 2*out_span, 5*out_span); \
	radix5_0(idft_Temp_Buf + 3, 5, OutBuf + 3*out_span, 5*out_span); \
	radix5_0(idft_Temp_Buf + 4, 5, OutBuf + 4*out_span, 5*out_span); \
}

#define radix27(InBuf, in_span, OutBuf, out_span, r27twiddle) \
{ \
	radix9_0_zeromul(InBuf + 0*in_span, 3*in_span, idft_Temp_Buf + 0*9, 1); \
	radix9_0_mul_span(InBuf + 1*in_span, 3*in_span, idft_Temp_Buf + 1*9, 1, r27twiddle + 2*9*1, 1); \
	radix9_0_mul_span(InBuf + 2*in_span, 3*in_span, idft_Temp_Buf + 2*9, 1, r27twiddle + 2*9*2, 1); \
	 \
	radix3_0(idft_Temp_Buf + 0, 9, OutBuf + 0*out_span, 9*out_span); \
	radix3_0(idft_Temp_Buf + 1, 9, OutBuf + 1*out_span, 9*out_span); \
	radix3_0(idft_Temp_Buf + 2, 9, OutBuf + 2*out_span, 9*out_span); \
	radix3_0(idft_Temp_Buf + 3, 9, OutBuf + 3*out_span, 9*out_span); \
	radix3_0(idft_Temp_Buf + 4, 9, OutBuf + 4*out_span, 9*out_span); \
	radix3_0(idft_Temp_Buf + 5, 9, OutBuf + 5*out_span, 9*out_span); \
	radix3_0(idft_Temp_Buf + 6, 9, OutBuf + 6*out_span, 9*out_span); \
	radix3_0(idft_Temp_Buf + 7, 9, OutBuf + 7*out_span, 9*out_span); \
	radix3_0(idft_Temp_Buf + 8, 9, OutBuf + 8*out_span, 9*out_span); \
}
...
{ \
	...
	radix9_0_mul_span(InBuf + 2*in_span, 3*in_span, idft_Temp_Buf + 2*9, 1, r27twiddle + 2*9*2, 1); \
	 \
	radix3_0_zeromul(idft_Temp_Buf + 0, 9, OutBuf + 0*out_span, 9*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 1, 9, OutBuf + 1*out_span, 9*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 2, 9, OutBuf + 2*out_span, 9*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 3, 9, OutBuf + 3*out_span, 9*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 4, 9, OutBuf + 4*out_span, 9*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 5, 9, OutBuf + 5*out_span, 9*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 6, 9, OutBuf + 6*out_span, 9*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 7, 9, OutBuf + 7*out_span, 9*out_span); \
	radix3_0_zeromul(idft_Temp_Buf + 8, 9, OutBuf + 8*out_span, 9*out_span); \
}
...
{ \
	...
	radix9_0_mul_span(InBuf + 2*in_span, 3*in_span, idft_Temp_Buf + 2*9, 1, r27twiddle + 2*9*2, 1); \
	 \
	radix3_0_mul_span(idft_Temp_Buf + 0, 9, OutBuf + 0*out_span, 9*out_span, twiddle + 2*out_span*twiddle_scale*0, 9*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 1, 9, OutBuf + 1*out_span, 9*out_span, twiddle + 2*out_span*twiddle_scale*1, 9*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 2, 9, OutBuf + 2*out_span, 9*out_span, twiddle + 2*out_span*twiddle_scale*2, 9*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 3, 9, OutBuf + 3*out_span, 9*out_span, twiddle + 2*out_span*twiddle_scale*3, 9*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 4, 9, OutBuf + 4*out_span, 9*out_span, twiddle + 2*out_span*twiddle_scale*4, 9*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 5, 9, OutBuf + 5*out_span, 9*out_span, twiddle + 2*out_span*twiddle_scale*5, 9*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 6, 9, OutBuf + 6*out_span, 9*out_span, twiddle + 2*out_span*twiddle_scale*6, 9*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 7, 9, OutBuf + 7*out_span, 9*out_span, twiddle + 2*out_span*twiddle_scale*7, 9*out_span*twiddle_scale); \
	radix3_mul_span(idft_Temp_Buf + 8, 9, OutBuf + 8*out_span, 9*out_span, twiddle + 2*out_span*twiddle_scale*8, 9*out_span*twiddle_scale); \
}

#define radix30(InBuf, in_span, OutBuf, out_span, r30twiddle) \
{ \
	radix6_0_zeromul(InBuf + 0*in_span, 5*in_span, idft_Temp_Buf + 0*6, 1); \
	radix6_0_mul_span(InBuf + 1*in_span, 5*in_span, idft_Temp_Buf + 1*6, 1, r30twiddle + 2*6*1, 1); \
	radix6_0_mul_span(InBuf + 2*in_span, 5*in_span, idft_Temp_Buf + 2*6, 1, r30twiddle + 2*6*2, 1); \
	radix6_0_mul_span(InBuf + 3*in_span, 5*in_span, idft_Temp_Buf + 3*6, 1, r30twiddle + 2*6*3, 1); \
	radix6_0_mul_span(InBuf + 4*in_span, 5*in_span, idft_Temp_Buf + 4*6, 1, r30twiddle + 2*6*4, 1); \
	 \
	radix5_0(idft_Temp_Buf + 0, 6, OutBuf + 0*out_span, 6*out_span); \
	radix5_0(idft_Temp_Buf + 1, 6, OutBuf + 1*out_span, 6*out_span); \
	radix5_0(idft_Temp_Buf + 2, 6, OutBuf + 2*out_span, 6*out_span); \
	radix5_0(idft_Temp_Buf + 3, 6, OutBuf + 3*out_span, 6*out_span); \
	radix5_0(idft_Temp_Buf + 4, 6, OutBuf + 4*out_span, 6*out_span); \
	radix5_0(idft_Temp_Buf + 5, 6, OutBuf + 5*out_span, 6*out_span); \
}

#define radix32(InBuf, in_span, OutBuf, out_span, r32twiddle) \
{ \
	radix8_0_zeromul(InBuf + 0*in_span, 4*in_span, idft_Temp_Buf + 0*8, 1); \
	radix8_0_mul(InBuf + 1*in_span, 4*in_span, idft_Temp_Buf + 1*8, 1, r32twiddle + 2*8*1); \
	radix8_0_mul(InBuf + 2*in_span, 4*in_span, idft_Temp_Buf + 2*8, 1, r32twiddle + 2*8*2); \
	radix8_0_mul(InBuf + 3*in_span, 4*in_span, idft_Temp_Buf + 3*8, 1, r32twiddle + 2*8*3); \
	 \
	radix4_0(idft_Temp_Buf + 0, 8, OutBuf + 0*out_span, 8*out_span); \
	radix4_0(idft_Temp_Buf + 1, 8, OutBuf + 1*out_span, 8*out_span); \
	radix4_0(idft_Temp_Buf + 2, 8, OutBuf + 2*out_span, 8*out_span); \
	radix4_0(idft_Temp_Buf + 3, 8, OutBuf + 3*out_span, 8*out_span); \
	radix4_0(idft_Temp_Buf + 4, 8, OutBuf + 4*out_span, 8*out_span); \
	radix4_0(idft_Temp_Buf + 5, 8, OutBuf + 5*out_span, 8*out_span); \
	radix4_0(idft_Temp_Buf + 6, 8, OutBuf + 6*out_span, 8*out_span); \
	radix4_0(idft_Temp_Buf + 7, 8, OutBuf + 7*out_span, 8*out_span); \
}

#define radix36(InBuf, in_span, OutBuf, out_span, r36twiddle) \
{ \
	radix6_0_zeromul(InBuf + 0*in_span, 6*in_span, idft_Temp_Buf + 0*6, 1); \
	radix6_0_mul_span(InBuf + 1*in_span, 6*in_span, idft_Temp_Buf + 1*6, 1, r36twiddle + 2*6*1, 1); \
	radix6_0_mul_span(InBuf + 2*in_span, 6*in_span, idft_Temp_Buf + 2*6, 1, r36twiddle + 2*6*2, 1); \
	radix6_0_mul_span(InBuf + 3*in_span, 6*in_span, idft_Temp_Buf + 3*6, 1, r36twiddle + 2*6*3, 1); \
	radix6_0_mul_span(InBuf + 4*in_span, 6*in_span, idft_Temp_Buf + 4*6, 1, r36twiddle + 2*6*4, 1); \
	radix6_0_mul_span(InBuf + 5*in_span, 6*in_span, idft_Temp_Buf + 5*6, 1, r36twiddle + 2*6*5, 1); \
	 \
	radix6_0(idft_Temp_Buf + 0, 6, OutBuf + 0*out_span, 6*out_span); \
	radix6_0(idft_Temp_Buf + 1, 6, OutBuf + 1*out_span, 6*out_span); \
	radix6_0(idft_Temp_Buf + 2, 6, OutBuf + 2*out_span, 6*out_span); \
	radix6_0(idft_Temp_Buf + 3, 6, OutBuf + 3*out_span, 6*out_span); \
	radix6_0(idft_Temp_Buf + 4, 6, OutBuf + 4*out_span, 6*out_span); \
	radix6_0(idft_Temp_Buf + 5, 6, OutBuf + 5*out_span, 6*out_span); \
}
...
{ \
	...
	radix6_0_mul_span(InBuf + 5*in_span, 6*in_span, idft_Temp_Buf + 5*6, 1, r36twiddle + 2*6*5, 1); \
	 \
	radix6_0_zeromul(idft_Temp_Buf + 0, 6, OutBuf + 0*out_span, 6*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 1, 6, OutBuf + 1*out_span, 6*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 2, 6, OutBuf + 2*out_span, 6*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 3, 6, OutBuf + 3*out_span, 6*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 4, 6, OutBuf + 4*out_span, 6*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 5, 6, OutBuf + 5*out_span, 6*out_span); \
}
...
{ \
	...
	radix6_0_mul_span(InBuf + 5*in_span, 6*in_span, idft_Temp_Buf + 5*6, 1, r36twiddle + 2*6*5, 1); \
	 \
	radix6_0_mul_span(idft_Temp_Buf + 0, 6, OutBuf + 0*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*0, 6*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 1, 6, OutBuf + 1*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*1, 6*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 2, 6, OutBuf + 2*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*2, 6*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 3, 6, OutBuf + 3*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*3, 6*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 4, 6, OutBuf + 4*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*4, 6*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 5, 6, OutBuf + 5*out_span, 6*out_span, twiddle + 2*out_span*twiddle_scale*5, 6*out_span*twiddle_scale); \
}

#define radix40_0_zeromul(InBuf, in_span, OutBuf, out_span, r40twiddle) \
{ \
	radix8_0_zeromul(InBuf + 0*in_span, 5*in_span, idft_Temp_Buf + 0*8, 1); \
	radix8_0_mul(InBuf + 1*in_span, 5*in_span, idft_Temp_Buf + 1*8, 1, r40twiddle + 2*8*1); \
	radix8_0_mul(InBuf + 2*in_span, 5*in_span, idft_Temp_Buf + 2*8, 1, r40twiddle + 2*8*2); \
	radix8_0_mul(InBuf + 3*in_span, 5*in_span, idft_Temp_Buf + 3*8, 1, r40twiddle + 2*8*3); \
	radix8_0_mul(InBuf + 4*in_span, 5*in_span, idft_Temp_Buf + 4*8, 1, r40twiddle + 2*8*4); \
	 \
	radix5_0_zeromul(idft_Temp_Buf + 0, 8, OutBuf + 0*out_span, 8*out_span); \
	radix5_0_zeromul(idft_Temp_Buf + 1, 8, OutBuf + 1*out_span, 8*out_span); \
	radix5_0_zeromul(idft_Temp_Buf + 2, 8, OutBuf + 2*out_span, 8*out_span); \
	radix5_0_zeromul(idft_Temp_Buf + 3, 8, OutBuf + 3*out_span, 8*out_span); \
	radix5_0_zeromul(idft_Temp_Buf + 4, 8, OutBuf + 4*out_span, 8*out_span); \
	radix5_0_zeromul(idft_Temp_Buf + 5, 8, OutBuf + 5*out_span, 8*out_span); \
	radix5_0_zeromul(idft_Temp_Buf + 6, 8, OutBuf + 6*out_span, 8*out_span); \
	radix5_0_zeromul(idft_Temp_Buf + 7, 8, OutBuf + 7*out_span, 8*out_span); \
}
...
{ \
	...
	radix8_0_mul(InBuf + 4*in_span, 5*in_span, idft_Temp_Buf + 4*8, 1, r40twiddle + 2*8*4); \
	 \
	radix5_0_mul_span(idft_Temp_Buf + 0, 8, OutBuf + 0*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*0, 8*out_span*twiddle_scale); \
	radix5_mul_span(idft_Temp_Buf + 1, 8, OutBuf + 1*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*1, 8*out_span*twiddle_scale); \
	radix5_mul_span(idft_Temp_Buf + 2, 8, OutBuf + 2*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*2, 8*out_span*twiddle_scale); \
	radix5_mul_span(idft_Temp_Buf + 3, 8, OutBuf + 3*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*3, 8*out_span*twiddle_scale); \
	radix5_mul_span(idft_Temp_Buf + 4, 8, OutBuf + 4*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*4, 8*out_span*twiddle_scale); \
	radix5_mul_span(idft_Temp_Buf + 5, 8, OutBuf + 5*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*5, 8*out_span*twiddle_scale); \
	radix5_mul_span(idft_Temp_Buf + 6, 8, OutBuf + 6*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*6, 8*out_span*twiddle_scale); \
	radix5_mul_span(idft_Temp_Buf + 7, 8, OutBuf + 7*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*7, 8*out_span*twiddle_scale); \
}

#define radix48(InBuf, in_span, OutBuf, out_span, r48twiddle) \
{ \
	radix8_0_zeromul(InBuf + 0*in_span, 6*in_span, idft_Temp_Buf + 0*8, 1); \
	radix8_0_mul(InBuf + 1*in_span, 6*in_span, idft_Temp_Buf + 1*8, 1, r48twiddle + 2*8*1); \
	radix8_0_mul(InBuf + 2*in_span, 6*in_span, idft_Temp_Buf + 2*8, 1, r48twiddle + 2*8*2); \
	radix8_0_mul(InBuf + 3*in_span, 6*in_span, idft_Temp_Buf + 3*8, 1, r48twiddle + 2*8*3); \
	radix8_0_mul(InBuf + 4*in_span, 6*in_span, idft_Temp_Buf + 4*8, 1, r48twiddle + 2*8*4); \
	radix8_0_mul(InBuf + 5*in_span, 6*in_span, idft_Temp_Buf + 5*8, 1, r48twiddle + 2*8*5); \
	 \
	radix6_0(idft_Temp_Buf + 0, 8, OutBuf + 0*out_span, 8*out_span); \
	radix6_0(idft_Temp_Buf + 1, 8, OutBuf + 1*out_span, 8*out_span); \
	radix6_0(idft_Temp_Buf + 2, 8, OutBuf + 2*out_span, 8*out_span); \
	radix6_0(idft_Temp_Buf + 3, 8, OutBuf + 3*out_span, 8*out_span); \
	radix6_0(idft_Temp_Buf + 4, 8, OutBuf + 4*out_span, 8*out_span); \
	radix6_0(idft_Temp_Buf + 5, 8, OutBuf + 5*out_span, 8*out_span); \
	radix6_0(idft_Temp_Buf + 6, 8, OutBuf + 6*out_span, 8*out_span); \
	radix6_0(idft_Temp_Buf + 7, 8, OutBuf + 7*out_span, 8*out_span); \
}
...
{ \
	...
	radix8_0_mul(InBuf + 5*in_span, 6*in_span, idft_Temp_Buf + 5*8, 1, r48twiddle + 2*8*5); \
	 \
	radix6_0_zeromul(idft_Temp_Buf + 0, 8, OutBuf + 0*out_span, 8*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 1, 8, OutBuf + 1*out_span, 8*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 2, 8, OutBuf + 2*out_span, 8*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 3, 8, OutBuf + 3*out_span, 8*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 4, 8, OutBuf + 4*out_span, 8*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 5, 8, OutBuf + 5*out_span, 8*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 6, 8, OutBuf + 6*out_span, 8*out_span); \
	radix6_0_zeromul(idft_Temp_Buf + 7, 8, OutBuf + 7*out_span, 8*out_span); \
}
...
{ \
	...
	radix8_0_mul(InBuf + 5*in_span, 6*in_span, idft_Temp_Buf + 5*8, 1, r48twiddle + 2*8*5); \
	 \
	radix6_0_mul_span(idft_Temp_Buf + 0, 8, OutBuf + 0*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*0, 8*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 1, 8, OutBuf + 1*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*1, 8*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 2, 8, OutBuf + 2*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*2, 8*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 3, 8, OutBuf + 3*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*3, 8*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 4, 8, OutBuf + 4*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*4, 8*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 5, 8, OutBuf + 5*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*5, 8*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 6, 8, OutBuf + 6*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*6, 8*out_span*twiddle_scale); \
	radix6_mul_span(idft_Temp_Buf + 7, 8, OutBuf + 7*out_span, 8*out_span, twiddle + 2*out_span*twiddle_scale*7, 8*out_span*twiddle_scale); \
}

static void idft12(__m128i *InBuf, __m128i *OutBuf, __m128i *r12twiddle)
{
	__m128i idft_Temp_Buf[12];
...
static void idft24(__m128i *InBuf, __m128i *OutBuf, __m128i *r24twiddle)
{
	__m128i idft_Temp_Buf[24];
...
static void idft36(__m128i *InBuf, __m128i *OutBuf, __m128i *r36twiddle)
{
	__m128i idft_Temp_Buf[36];
	__m128i m128_t0,m128_t1,m128_t2,m128_t3,m128_t4,m128_t5,m128_t6,m128_t7,m128_t8,m128_t9,m128_t10,m128_t11,m128_t12,m128_t13;
	radix36((__m128i *)InBuf, 1, (__m128i *)OutBuf, 1, (__m128i *)r36twiddle);
}

static void idft48(__m128i *InBuf, __m128i *OutBuf, __m128i *r48twiddle)
{
	__m128i idft_Temp_Buf[48];
	__m128i m128_t0,m128_t1,m128_t2,m128_t3,m128_t4,m128_t5,m128_t6,m128_t7,m128_t8,m128_t9,m128_t10,m128_t11,m128_t12,m128_t13;

	radix48((__m128i *)InBuf, 1, (__m128i *)OutBuf, 1, (__m128i *)r48twiddle);
}

static void idft60(__m128i *InBuf, __m128i *OutBuf, __m128i *r12twiddle, __m128i *r5twiddle, __m128i *r720twiddle)
{
    WORD32 i;
...
static void idft72(__m128i *InBuf, __m128i *OutBuf, __m128i *r9twiddle, __m128i *r8twiddle, __m128i *r648twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[72];
...
static void idft96(__m128i *InBuf, __m128i *OutBuf, __m128i *r12twiddle, __m128i *r8twiddle, __m128i *r768twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[96];
...
static void idft108(__m128i *InBuf, __m128i *OutBuf, __m128i *r9twiddle, __m128i *r12twiddle, __m128i *r648twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[108];
...
static void idft120(__m128i *InBuf, __m128i *OutBuf, __m128i *r24twiddle, __m128i *r5twiddle, __m128i *r1200twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[120];
...
static void idft144(__m128i *InBuf, __m128i *OutBuf, __m128i *r12twiddle, __m128i *r864twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[144];
...
static void idft180(__m128i *InBuf, __m128i *OutBuf, __m128i *r12twiddle, __m128i *r15twiddle, __m128i *r1080twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[180];
	__m128i idft_Temp_Buf[15];
	__m128i m128_t0,m128_t1,m128_t2,m128_t3,m128_t4,m128_t5,m128_t6,m128_t7,m128_t8,m128_t9,m128_t10,m128_t11,m128_t12;
...
static void idft192(__m128i *InBuf, __m128i *OutBuf, __m128i *r16twiddle, __m128i *r12twiddle, __m128i *r1152twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[192];
	__m128i idft_Temp_Buf[16];
	__m128i m128_t0,m128_t1,m128_t2,m128_t3,m128_t4,m128_t5,m128_t6,m128_t7,m128_t8,m128_t9,m128_t10,m128_t11;
...
static void idft216(__m128i *InBuf, __m128i *OutBuf, __m128i *r18twiddle, __m128i *r12twiddle, __m128i *r864twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[216];
	__m128i idft_Temp_Buf[18];
	__m128i m128_t0,m128_t1,m128_t2,m128_t3,m128_t4,m128_t5,m128_t6,m128_t7,m128_t8,m128_t9,m128_t10,m128_t11,m128_t12,m128_t13;
...
static void idft240(__m128i *InBuf, __m128i *OutBuf, __m128i *r20twiddle, __m128i *r12twiddle, __m128i *r960twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[240];
	__m128i idft_Temp_Buf[20];
	__m128i m128_t0,m128_t1,m128_t2,m128_t3,m128_t4,m128_t5,m128_t6,m128_t7,m128_t8,m128_t9,m128_t10,m128_t11,m128_t12;
...
static void idft288(__m128i *InBuf, __m128i *OutBuf, __m128i *r12twiddle, __m128i *r24twiddle, __m128i *r864twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[288];
...
static void idft300(__m128i *InBuf, __m128i *OutBuf, __m128i *r12twiddle, __m128i *r25twiddle, __m128i *r1200twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[300];
	__m128i idft_Temp_Buf[25];
	__m128i m128_t0,m128_t1,m128_t2,m128_t3,m128_t4,m128_t5,m128_t6,m128_t7,m128_t8,m128_t9,m128_t10,m128_t11,m128_t12;
...
static void idft324(__m128i *InBuf, __m128i *OutBuf, __m128i *r12twiddle, __m128i *r27twiddle, __m128i *r972twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[324];
	__m128i idft_Temp_Buf[27];
	__m128i m128_t0,m128_t1,m128_t2,m128_t3,m128_t4,m128_t5,m128_t6,m128_t7,m128_t8,m128_t9,m128_t10,m128_t11,m128_t12,m128_t13;
...
static void idft360(__m128i *InBuf, __m128i *OutBuf, __m128i *r18twiddle, __m128i *r20twiddle, __m128i *r720twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[360];
...
static void idft384(__m128i *InBuf, __m128i *OutBuf, __m128i *r16twiddle, __m128i *r24twiddle, __m128i *r1152twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[384];
...
static void idft432(__m128i *InBuf, __m128i *OutBuf, __m128i *r18twiddle, __m128i *r24twiddle, __m128i *r864twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[432];
...
static void idft480(__m128i *InBuf, __m128i *OutBuf, __m128i *r20twiddle, __m128i *r24twiddle, __m128i *r960twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[960];
...
static void idft540(__m128i *InBuf, __m128i *OutBuf, __m128i *r18twiddle, __m128i *r30twiddle, __m128i *r1080twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[1080];
	__m128i idft_Temp_Buf[30];
	__m128i m128_t0,m128_t1,m128_t2,m128_t3,m128_t4,m128_t5,m128_t6,m128_t7,m128_t8,m128_t9,m128_t10,m128_t11,m128_t12,m128_t13;
...
static void idft576(__m128i *InBuf, __m128i *OutBuf, __m128i *r24twiddle, __m128i *r1152twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[576];
...
static void idft600(__m128i *InBuf, __m128i *OutBuf, __m128i *r24twiddle, __m128i *r25twiddle, __m128i *r1200twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[600];
...
static void idft648(__m128i *InBuf, __m128i *OutBuf, __m128i *r27twiddle, __m128i *r24twiddle, __m128i *r648twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[648];
...
static void idft720(__m128i *InBuf, __m128i *OutBuf, __m128i *r36twiddle, __m128i *r20twiddle, __m128i *r720twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[720];
...
static void idft768(__m128i *InBuf, __m128i *OutBuf, __m128i *r48twiddle, __m128i *r16twiddle, __m128i *r768twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[768];
...
static void idft864(__m128i *InBuf, __m128i *OutBuf, __m128i *r36twiddle, __m128i *r24twiddle, __m128i *r864twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[864];
...
static void idft900(__m128i *InBuf, __m128i *OutBuf, __m128i *r36twiddle, __m128i *r25twiddle, __m128i *r900twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[900];
...
static void idft960(__m128i *InBuf, __m128i *OutBuf, __m128i *r40twiddle, __m128i *r24twiddle, __m128i *r960twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[960];
	__m128i idft_Temp_Buf[40];
	__m128i m128_t0,m128_t1,m128_t2,m128_t3,m128_t4,m128_t5,m128_t6,m128_t7,m128_t8,m128_t9,m128_t10,m128_t11,m128_t12, m128_t13;
...
static void idft972(__m128i *InBuf, __m128i *OutBuf, __m128i *r36twiddle, __m128i *r27twiddle, __m128i *r972twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[972];
...
static void idft1080(__m128i *InBuf, __m128i *OutBuf, __m128i *r36twiddle, __m128i *r30twiddle, __m128i *r1080twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
	__m128i OutTemp[1080];
...
static void idft1152(__m128i *InBuf, __m128i *OutBuf, __m128i *r48twiddle, __m128i *r24twiddle, __m128i *r1152twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
...
static void idft1200(__m128i *InBuf, __m128i *OutBuf, __m128i *r48twiddle, __m128i *r25twiddle, __m128i *r1200twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
...
static void idft1536(__m128i *InBuf, __m128i *OutBuf, __m128i *r48twiddle, __m128i *r32twiddle, __m128i *r1536twiddle)
{
    WORD32 i;
    WORD32 in_span, out_span;
...
void gen_idft(__m128i *InBuf, __m128i *OutBuf, DFTtwiddleStruct * psTwiddleBuffer, WORD32 idft_idx)
{
    ...
    {
    case 1536:
        idft1536((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r48twiddle, (__m128i *)psTwiddleBuffer->pIdft_r32twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1536twiddle);
        break;
    case 1200:
        idft1200((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r48twiddle, (__m128i *)psTwiddleBuffer->pIdft_r25twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1200twiddle);
        break;
    case 1152:
        idft1152((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r48twiddle, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1152twiddle);
        break;
    case 1080:
        idft1080((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r36twiddle, (__m128i *)psTwiddleBuffer->pIdft_r30twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1080twiddle);
        break;
    case 972:
        idft972((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r36twiddle, (__m128i *)psTwiddleBuffer->pIdft_r27twiddle, (__m128i *)psTwiddleBuffer->pIdft_r972twiddle);
        break;
    case 960:
        idft960((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r40twiddle, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, (__m128i *)psTwiddleBuffer->pIdft_r960twiddle);
        break;
    case 900:
        idft900((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r36twiddle, (__m128i *)psTwiddleBuffer->pIdft_r25twiddle, (__m128i *)psTwiddleBuffer->pIdft_r900twiddle);
        break;
    case 864:
        idft864((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r36twiddle, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, (__m128i *)psTwiddleBuffer->pIdft_r864twiddle);
        break;
    case 768:
        idft768((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r48twiddle, (__m128i *)psTwiddleBuffer->pIdft_r16twiddle, (__m128i *)psTwiddleBuffer->pIdft_r768twiddle);
        break;
    case 720:
        idft720((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r36twiddle, (__m128i *)psTwiddleBuffer->pIdft_r20twiddle, (__m128i *)psTwiddleBuffer->pIdft_r720twiddle);
        break;
    case 648:
        idft648((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r27twiddle, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, (__m128i *)psTwiddleBuffer->pIdft_r648twiddle);
        break;
    case 600:
        idft600((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, (__m128i *)psTwiddleBuffer->pIdft_r25twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1200twiddle);
        break;
    case 576:
        idft576((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1152twiddle);
        break;
    case 540:
        idft540((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r18twiddle, (__m128i *)psTwiddleBuffer->pIdft_r30twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1080twiddle);
        break;
    case 480:
        idft480((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r20twiddle, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, (__m128i *)psTwiddleBuffer->pIdft_r960twiddle);
        break;
    case 432:
        idft432((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r18twiddle, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, (__m128i *)psTwiddleBuffer->pIdft_r864twiddle);
        break;
    case 384:
        idft384((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r16twiddle, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1152twiddle);
        break;
    case 360:
        idft360((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r18twiddle, (__m128i *)psTwiddleBuffer->pIdft_r20twiddle, (__m128i *)psTwiddleBuffer->pIdft_r720twiddle);
        break;
    case 324:
        idft324((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, (__m128i *)psTwiddleBuffer->pIdft_r27twiddle, (__m128i *)psTwiddleBuffer->pIdft_r972twiddle);
        break;
    case 300:
        idft300((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, (__m128i *)psTwiddleBuffer->pIdft_r25twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1200twiddle);
        break;
    case 288:
        idft288((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, (__m128i *)psTwiddleBuffer->pIdft_r864twiddle);
        break;
    case 240:
        idft240((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r20twiddle, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, (__m128i *)psTwiddleBuffer->pIdft_r960twiddle);
        break;
    case 216:
        idft216((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r18twiddle, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, (__m128i *)psTwiddleBuffer->pIdft_r864twiddle);
        break;
    case 192:
        idft192((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r16twiddle, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1152twiddle);
        break;
    case 180:
        idft180((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, (__m128i *)psTwiddleBuffer->pIdft_r15twiddle, (__m128i *)psTwiddleBuffer->pIdft_r1080twiddle);
        break;
    case 144:
        idft144((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, (__m128i *)psTwiddleBuffer->pIdft_r864twiddle);
        break;
    case 120:
        idft120((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle, NULL, (__m128i *)psTwiddleBuffer->pIdft_r1200twiddle);
        break;
    case 108:
        idft108((__m128i *)InBuf, (__m128i *)OutBuf, NULL, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, (__m128i *)psTwiddleBuffer->pIdft_r648twiddle);
        break;
    case 96:
        idft96((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, NULL, (__m128i *)psTwiddleBuffer->pIdft_r768twiddle);
        break;
    case 72:
        idft72((__m128i *)InBuf, (__m128i *)OutBuf, NULL, NULL, (__m128i *)psTwiddleBuffer->pIdft_r648twiddle);
        break;
    case 60:
        idft60((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle, NULL, (__m128i *)psTwiddleBuffer->pIdft_r720twiddle);
        break;
    case 48:
        idft48((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r48twiddle);
        break;
    case 36:
        idft36((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r36twiddle);
        break;
    case 24:
        idft24((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r24twiddle);
        break;
    case 12:
        idft12((__m128i *)InBuf, (__m128i *)OutBuf, (__m128i *)psTwiddleBuffer->pIdft_r12twiddle);
        break;
    default:
        printf("the points number %d of IDFT is wrong, please check it!\n", idft_idx); 
        break;
    }
    return;
}
